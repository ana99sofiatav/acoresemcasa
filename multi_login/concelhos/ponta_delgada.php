...
<html lang="pt">
    ...
    <body>
        ...
        <h1>Ponta Delgada</h1>
        <img align="right" src="../js_css/images/azores_images/concelhos/ponta_delgada_flag.png" alt="Bandeira de Lagoa"/>
        <main>
            ...
            <section id="content1">
                ...
                <div id="concelhosmap">
                    <svg width="580" height="400" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g>
                            <a xlink:href="freguesias/ponta_delgada/candelária.php">
                ...
                <div id="intro">
                    ...
                    <dd>
                        <p>Pilar da Bretanh</p>
                    </dd>
                    <dd>
                        <p>São José (Ponta Delgada)</p>
                    </dd>
                    <dd>
                        <p>São Pedro (Ponta Delgada)</p>
                    </dd>
                    <dd>
                        <p>São Sebastião (Ponta Delgada)</p>
                    </dd>
                    <dd>
                        <p>Relva (Ponta Delgada)</p>
                    </dd>
                    <dd>
                        <p>Remédios (Ponta Delgada)</p>
                    </dd>
                    <dd>
                        <p>Santa Bárbara (Ponta Delgada)</p>
                    </dd>
                    <dd>
                        <p>Santa Clara (Ponta Delgada)</p>
                    </dd>
                    <dd>
                        <p>Santo António (Ponta Delgada)</p>
                    </dd>
                    <dd>
                        <p>São Roque (Ponta Delgada)</p>
                    </dd>
                    <dd>
            ...
            <section id="content3">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!4v1549844130861!6m8!1m7!1st8K1zN7-oR6rvTMIEEQcCg!2m2!1d37.73966550591074!2d-25.66842527325479!3f178.33702424930502!4f16.210604117292476!5f0.4005941996036101" width="100%" height="350" frameborder="0" style="border:0" allowfullscreen></iframe>
                <div id="intro">
            ...
            <section id="content4">
                <div id="captioned-gallery">
                    <div id="captioned-gallery">
                        <figure class="slider">
                            <figure>
                                <img src="js_css/images/azores_images/cidades/ponta_delgada/img1.jpg" alt/>
                                <figcaption>Cidade de Ponta Delgada</figcaption>
                            </figure>
                            <figure>
                                <img src="js_css/images/azores_images/cidades/ponta_delgada/img2.jpg" alt/>
                                <figcaption>Marina de Ponta Delgada</figcaption>
                            </figure>
                            <figure>
                                <img src="js_css/images/azores_images/cidades/ponta_delgada/img3.jpg" alt/>
                                <figcaption>Jardim de Ponta Delgada</figcaption>
                            </figure>
                            <figure>
                                <img src="js_css/images/azores_images/cidades/ponta_delgada/img4.jpg" alt/>
                                <figcaption>Natureza de Ponta Delgada</figcaption>
                            </figure>
                        </figure>
                    </div>
            </section>
