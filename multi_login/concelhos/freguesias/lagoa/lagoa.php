...
<body>
   <div class="divmenu">
        <ul  class="menu">
            ...
            <div id="menuright">
            <li id="menuli"><a id="letramenu" href='../multi_login/login.php'>Login</a></li></div>
...
<p><p></p></p><p><p><p></p></p></p>
  ...
  <section id="content3">
    ...
    <div id="intro">
    <p>A lagoa é um dos concelhos mais pequenos da ilha de São Miguel.<br> Aqui está uma linda paisagem do pôr do sol no concelho.</p>
  </div>
