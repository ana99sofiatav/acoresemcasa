...
if (isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO tbl_user_comments_vila_franca_do_campo (username, message) VALUES ('$username', '$message')";
...
<?php
    ...
    $sql_sel = "SELECT * FROM tbl_user_comments_vila_franca_do_campo WHERE id = $comment_id";
