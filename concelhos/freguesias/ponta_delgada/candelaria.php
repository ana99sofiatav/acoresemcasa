   ...
   <body>
      ...
      <div id="corpo">
         ...
         <main>
            ...
            <label for="tab3">
               <p>Pontos de Interesse e Curiosidades</p>
            </label>
            ...
            <section id="content1">
               ...
               <div id="intro">
                  <h1>Factos</h1>
                  Candelária é uma freguesia rural açoriana do concelho de Ponta Delgada, com 8,53 km² de área e 1 079 habitantes (2011), o que corresponde a uma densidade populacional de 126,5 hab/km².
               </div>
            </section>
            <section id="content2">
               <div id="intro">
                  ...
                  <p></p>
                  <img style="display: block;  width:100%; max-height:330px;object-fit:contain;" src="../imgens/ponta_delgada/candelaria/temporal.png" alt="Bretanha"/>
                  <p> </p>
                  <br><br><br>
                  <p></p>
            ...
            <section id="content3">
               <h1>A igreja paroquial</h1>
               <div id="intro">
                  <img style="display: block;  width:100%; max-height:330px;object-fit:contain;" src="../imgens/ponta_delgada/candelaria/paroquial.png" alt="Bretanha"/>
                  <p> </p>
                  <p> </p>
                  <br>
                  <p> </p>
                  ...
                  <p> </p>
                  <p> </p>
                  <h1>A Ermida de Nossa Senhora do Perpétuo Socorro</h1>
                  <p></p>
                  <img style="display: block;  width:100%; max-height:330px;object-fit:contain;" src="../imgens/ponta_delgada/candelaria/ermida.png" alt="Bretanha"/>
                  <p> </p>
                  <p> </p>
                  Escreve o Padre Lopes da Luz na Monographia da Candelária, publicada no Arquivo dos Açores, que esta não podia ter sido erguida em "logar mais exposto às ventanias da estação invernosa, mas é por isso mesmo e pela sua belíssima vista de mar que não podemos sem grande custo sair de lá (...) tem sido ela desde antiquíssimos tempos o santuário de maior veneração de todos os povos da costa ocidental da nossa ilha". Reza a lenda que decorria o século dezasseis e, ao largo da costa ocidental da ilha de S. Miguel, navegava um navio inglês, uma tempestade que já se vinha preparando há umas horas, rebentou finalmente.
                  <p></p>
                  <br> Os marinheiros puseram em prática todos os seus conhecimentos de navegação, mas a força do vento e das altas vagas era tanta que de nada lhes valeu arte e vigor. Com as velas rotas e o leme partido, o navio andava à deriva e a tripulação estava desorientada sem saber o que fazer, temendo que o frágil barco se despedaçasse contra os rochedos altos e escarpados da costa. <br><br>
                  <br>
                  <img style="display: block;  width:100%; max-height:330px;object-fit:contain;" src="../imgens/ponta_delgada/candelaria/naufragio.png" alt="Bretanha"/>
                  <p> </p>
                  <br><br>
                  A aflição era enorme, ouvia-se gritos desesperados e rezas fervorosas e, no meio da confusão, formularam o voto de mandar construir uma ermida a Nossa Senhora do Socorro no lugar certo onde caísse uma bola de ferro, lançada de bordo, caso a Virgem viesse em seu auxílio. Cheios de fé apontaram o canhão e lançaram a bola. Mas, com a agitação do navio e força do vento, ela foi cair no declive de um pico junto ao mar na freguesia da Candelária. A prece foi ouvida. Em pouco tempo o vento abrandou, as ondas acalmaram-se e a pequena caravela, praticamente destruída, ancorou por fim na baía mais próxima.<br><br> Os marinheiros, totalmente exaustos da força despendida e da angústia por que haviam passado, abraçavam-se e choravam de alegria. Não se esqueceu a promessa e a ermida de Nossa Senhora do Socorro foi construída em lugar exposto às ventanias e aí está com o seu pequeno adro, embelezando a paisagem que dali se desfruta, tudo por causa da força do mar e de uma grande tempestade.
                  <p></p>
                  ...
                  <p></p>
                  <dd>“Virgem do Socorro, Mãe da Piedade, pedi ao Senhor pela cristandade. Eu sou pecador, não vos sei pedir, não sou merecedor do Senhor me ouvir”</dd>
                  <p>
                  <p>-</p>
                  </p>
                  <h1>Tradições e Costumes</h1>
                  <h2>Cantar às Estrelas</h2>
                  <p></p>
                  Na noite que precede o dia 2 de Fevereiro (dia de Nossa Senhora da Estrela ou das Candeias), percorrem as ruas da freguesia alguns cantadores inspirados, acompanhados de guitarra e viola da terrra, cantando e parando às portas de diversas moradias até que a entrada lhes seja franqueada.
                  <p></p>
                  ...
                  <br><br><br>
                  <dd>"vejo uma estrela a brilhar,</dd>
                  <dd>nesta direção virada,</dd>
                  <dd>que está a indicar</dd>
                  <dd>para parar nesta morada"</dd>
                  <dd>"hoje é dia das estrelas,</dd>
                  <dd>cantamos em romarias,</dd>
                  <dd>para agradecer aquelas,</dd>
                  <dd>que brilham todos os dias"</dd>
                  <dd>"uma estrela a brilhar,</dd>
                  <dd>tem um sentido profundo,</dd>
                  <dd>não se podem comparar,</dd>
                  <dd>a luz nenhuma do mundo"</dd>
                  <h1>Capelas</h1>
                  As capelas são uma tradição muito antiga na Candelária. Grupos de pessoas, fazendo-se acompanhar de instrumentos musicais, vão de porta em porta, noite alta, cumprimentar vizinhos e amigos, desejando-lhes boas festas de natal. Os cantares e sons harmoniosos da música, ecoando no silêncio da noite, acordam até os mais sonlentos.
                  ...
                  <br><br><br>
                  <dd>"Viva a noite de natal</dd>
                  <dd>noite de tanta alegria</dd>
                  <dd>viva o rei universal</dd>
                  <dd>viva josé e maria"</dd>
                  <dd>"um raminho, dois raminhos</dd>
                  <dd>três raminhos em flor</dd>
                  <dd>vida os donos desta casa</dd>
                  <dd>que esta vai a seu favor"</dd>
                  <dd>"a tua porta parei</dd>
                  <dd>logo pus o pé na escada</dd>
                  <dd>logo o meu coração me disse</dd>
                  <dd>que aqui mora gente honrada"</dd>
                  <dd>Fábrico das Candeias</dd>
                  <dd>Os Maios</dd>
               </div>
               <br>
            </section>
            <section id="content4">
               <div id="simple-gallery">
                  <dl id="simple-gallery">
                     <dt tabindex="1"><img src="../imgens/ponta_delgada/candelaria/paroquial.png" alt>
                     <dd><img src="../imgens/ponta_delgada/candelaria/paroquial.png" alt>Igreja Paroquial
                     <dt tabindex="2"><img src="../imgens/ponta_delgada/candelaria/ermida.png" alt>
                     <dd><img src="../imgens/ponta_delgada/candelaria/ermida.png" alt>Ermida de Nossa Senhora do Perpétuo Socorro
                     <dt tabindex="4"><img src="../imgens/ponta_delgada/candelaria/candelaria.png" alt>
                     <dd><img src="../imgens/ponta_delgada/candelaria/candelaria.png" alt>Encosta de Candelária ao anoitecer
                     <dt tabindex="5"><img src="../imgens/ponta_delgada/candelaria/candelaria2.png" alt>
                     <dd><img src="../imgens/ponta_delgada/candelaria/candelaria2.png" alt>Encosta de Candelária ao anoitecer
                     <dt tabindex="6"><img src="../imgens/ponta_delgada/candelaria/candelaria3.png" alt>
                     <dd><img src="../imgens/ponta_delgada/candelaria/candelaria3.png" alt>Mapa e bandeira de Candelária
                  </dl>
               </div>
            </section>
         </main>
