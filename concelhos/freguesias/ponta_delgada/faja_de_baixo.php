        ...
        <div id="corpo">
            ...
            <main>
                ...
                <section id="content1">
                    ...
                    <div id="intro">
                        <h1>Factos</h1>
                        Fajã de Baixo é uma freguesia no concelho de Ponta Delgada no Português arquipélago dos Açores. A população em 2011 era 5.050, em uma área de 4,06 km². Faja de Baixo situa-se na parte ocidental da ilha de São Miguel , a nordeste do centro de Ponta Delgada.
                    </div>
                </section>
                <section id="content2">
                    <div id="intro">
                        <p></p>
                        <h1>História e pontos de interesse</h1>
                        
                        <p></p>
                       A primeira Igreja da Fajã foi erguida em 1532, para apoiar a pequena comunidade que começou a se instalar na região.  Mas, esta pequena igreja foi incapaz de sustentar a crescente congregação e foi condenada a ser demolida alguns anos depois. 
                       <h1>Igreja Nossa Senhora dos Anjos</h1>
<img style="display: block;  width:100%; max-height:350px;object-fit:cover;" src="https://www.rotasturisticas.pt/imagens/fotos/pt/large/fotos_19968_faja_de_baixo_igreja_de_nossa_senhora_dos_anjos_faja_de_baixo_.jpg" alt="Bretanha"/>
Em 1699, o Hermitage de Lorêto foi concluído e serviu como templo principal para a comunidade.  A principal igreja paroquial, dedicada a Nossa Senhora dos Anjos foi finalmente construída em 1791.  Enquanto isso, a região era um destino de peregrinações anuais, com paradas nos templos menores. no Hermitage da Senhora da Boa Nova e Hermitage de Santa Rita (erguido em 1765).
                    </div>
                </section>
                <section id="content3">
                    <h1>Igreja de Nossa Senhora dos Anjos</h1>
                    <div id="intro">
