      ...
      <div id="corpo">
         ...
         <main>
            ...
            <section id="content1">
               ...
               <div id="intro">
                  <h1>Factos</h1>
                  Capelas é uma vila e sede de freguesia açoriana do concelho de Ponta Delgada, com 16,84 km² de área e 4 080 habitantes (2011). A sua densidade populacional é 242,3 hab/km². Localiza-se a uma latitude 37.833 (37°50') Norte e a uma longitude 25.6833 (25°41') Oeste, estando a uma altitude de 60 metros. A actividade principal é a agricultura. É banhada pelo Oceano Atlântico. Tem montanhas a sul.
               </div>
            </section>
            <section id="content2">
               <div id="intro">
                  <p></p>
                  <h1>Cultura e História</h1>
...
<img style="display: block;  width:100%; max-height:330px;object-fit:contain;" src="../imgens/ponta_delgada/candelaria/temporal.png" alt="Bretanha"/>
            ...
            <section id="content3">
               <h1> Igreja de Nossa Senhora da Apresentação</h1>
               <div id="intro">
...
O interior com a imagem de Nossa Senhora da Apresentação no altar-mor apresenta bons acabamentos.<br><br>


                  <p></p>
                  <p> </p>
                  <p> </p>
                  <h1>Miradouro da Vigia das Baleias (Capelas)</h1><p></p>
                  ...
                  <p> </p>
                  <p> </p>
                  O Miradouro da Vigia das Baleias (Capelas) é um miradouro português localizado na freguesia das Capelas, concelho de Ponta Delgada, ilha de São Miguel, arquipélago dos Açores. O miradouro é utilizado por empresa privada para a observação e localização de cetáceos, com fins destinados ao whale watching. Este miradouro oferece à vista uma paisagem que se estende ao longo da costa Norte da ilha permitindo ver uma paisagem de grande amplitude tendo sempre o mar como fundo.
               </div>
               <br>
            ...
            <section id="content4">
               <div id="simple-gallery">
                  <dl id="simple-gallery">
                     ...
                     <dt tabindex="3"><img src="../imgens/ponta_delgada/candelaria/candeias.png" alt>
                     <dd><img src="../imgens/ponta_delgada/candelaria/candeias.png" alt>Igreja de Nossa Senhora das Candeias
