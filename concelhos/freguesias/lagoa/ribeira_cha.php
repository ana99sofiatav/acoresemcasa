...
<html lang="pt">
    ...
    <body>
        ...
        <section id="content2">
            <h1>História</h1>
        <div id="intro">
            Apesar do povoamento ser antigo, existindo antes de 1637, o povoado apenas foi elevado a curato em 1902 e a freguesia e paróquia em 1966, tendo funcionado sempre na área de influência da antiga vila de Água de Pau. <p><br></p>O desenvolvimento do lugar ganhou grande dinamismo a partir da década de 1960, em boa parte por influência do padre João Caetano Flores, com a elevação a freguesia, a construção de uma moderna igreja, a criação de um invejável núcleo museológico e o aparecimento de diversas instituições, entre elas um jardim-de-infância pioneiro na educação pré-escolar na ilha de São Miguel.
...
<dd>Museu de Arte Sacra e Etnografia;</dd>
<dd>Museu Agrícola e Quintal Etnográfico e de Endemismo Açórico;</dd>
<dd>Núcleo Museológico da Cultura do Pastel nos Açores;</dd>
<dd>Museu do Vinho e a Casa Maria dos Anjos Melo.</dd>
            </div>
        </section>
        </main>
            <h1>Freguesias</h1>
