...
<html lang="pt">
    ...
    <body>
        ...
        <div id="intro">
        Santa Cruz é uma freguesia portuguesa do concelho da Lagoa, com 14,26 km² de área e 3 671 habitantes (2011). A sua densidade populacional é 257,4 hab/km².
        </div>
        </section>
        ...
        <section id="content2">
            <h1>História</h1>
        <div id="intro">
        <dd>Convento dos Franciscanos</dd>
        <dd>Forte de Santa Cruz da Lagoa</dd>
        </div>
        <br>
        ...
        <section id="content3">
        <div id="intro">
            <h1>Património edificado</h1></div>
        </section>
        <section id="content4">
            <h1>Cultura</h1>
            <div id="intro">
