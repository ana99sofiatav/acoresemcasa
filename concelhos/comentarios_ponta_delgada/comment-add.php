...
if (isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO tbl_user_comments_ponta_delgada (username, message) VALUES ('$username', '$message')";
...
<?php
    ...
    $sql_sel = "SELECT * FROM tbl_user_comments_ponta_delgada WHERE id = $comment_id";
